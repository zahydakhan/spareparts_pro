...
export default function EnhancedTable({ rows, mainOrder, setMainOrder }) {
  ...
  const handleSubmit = (row) => (event) => {
    ...
    setMainOrder([...mainOrder, row]);

    axiosInstance
      .delete("/parts/admin-order/delete-order/" + row.id)
